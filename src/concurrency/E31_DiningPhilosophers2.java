...
class Chopstick1 {
	...
	public String toString() {
		return "Chopstick1 " + id;
	}
}

class ChopstickQueue extends LinkedBlockingQueue<Chopstick1> {
}

class ChopstickBin {
	private ChopstickQueue bin = new ChopstickQueue();

	public Chopstick1 get() throws InterruptedException {
		return bin.take();
	}

	public void
	put(Chopstick1 stick) throws InterruptedException {
		bin.put(stick);
//		Concurrency  653
	}
}
...
class Philosopher1 implements Runnable {
	...
	public Philosopher1(ChopstickBin bin, int ident,
						int ponder) {
		this.bin = bin;
		id = ident;
		ponderFactor = ponder;
...
public class E31_DiningPhilosophers2 {
	public static void main(String[] args) throws Exception {
		if ( args.length < 3 ) {
//			Thinking in Java, 4 th Edition Annotated Solution Guide  654
