...
public class E18_TextFile2 {
    public static void main(String[] args) throws IOException{
        String file = TextFile2.read("F:\\think\\thinkinjava\\src\\net\\mindview\\util\\E18_TextFile2.java");
        TextFile2.write("test.txt", file);
        TextFile2 text = new TextFile2("test.txt");
        text.write("test2.txt");
// Break into unique sorted list of words:
        TreeSet<String> words = new TreeSet<String>(new TextFile2("F:\\think\\thinkinjava\\src\\net\\mindview\\util\\E18_TextFile2.java", "\\W+"));
