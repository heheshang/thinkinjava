...
*///:~
/**
 * As stated in the JDK documentation, System.nanoTime( ) “provides
 * nanosecond precision, but not necessarily nanosecond accuracy” (results vary
 * on different computers). This is the main reason the output cannot be matched
