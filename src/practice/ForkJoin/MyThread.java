...
/**
 * 类MyThread.java的功能描述:1.创建一个继承Thread类的MyThread类。
 *
 * @author ssk 2017-02-27 下午 7:07 www.hnapay.com Inc.All rights reserved
 * @version v1.0
 */
...
class TestMain {
    public static void main(String[] args) throws Exception{
        ...
        TestMain.MyThreadFactory myFactory = new TestMain.MyThreadFactory("MyThreadFactory");
        //18.创建一个Task对象。
